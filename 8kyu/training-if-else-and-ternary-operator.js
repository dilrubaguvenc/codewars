...
// If the statementa or statementb are more than one line, you need to add { and } at the head and tail of statements 
// in JS, to keep the same indentation on Python and to put an end in Ruby where it indeed ends.
